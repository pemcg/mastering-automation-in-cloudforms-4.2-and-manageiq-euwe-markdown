...
The *provision task object* is created once the virtual machine
...
The destination object is accessible as an association from the task
object:
...
In the case of provisioning a virtual machine, the same destination
